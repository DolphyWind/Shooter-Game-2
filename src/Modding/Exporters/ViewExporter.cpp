...
void ViewExporter::createView(lua_State *L, const Exported_View& view)
{
    void* data = lua_newuserdata(L, sizeof(Exported_View));
    new (data) Exported_View(view);
...
int ViewExporter::__new(lua_State *L)
{
    ...
    else if(arg_count == 1)
    {
        ...
        createView(L, Exported_View(*rectanglePtr));
        return 1;
    }
    ...
    createView(L, Exported_View(*centerPtr, *sizePtr));
...
{
    Exported_View* viewPtr = static_cast<Exported_View*>( LuaHelper::checkudata_WithError(L, 1, LUA_VIEW_METATABLENAME) );
    viewPtr->~Exported_View();
    return 0;
}
...
int ViewExporter::setRotation(lua_State *L)
{
    Exported_View* viewPtr = static_cast<Exported_View*>( LuaHelper::checkudata_WithError(L, 1, LUA_VIEW_METATABLENAME) );
...
LuaExporter ViewExporter::toLuaExporter()
{
    LuaExporter exporter(
        ...
        __new,
        {
            ...
            {"setRotation", ViewExporter::setRotation},
